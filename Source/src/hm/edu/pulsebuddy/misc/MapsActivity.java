...
public class MapsActivity extends Activity implements ActivityListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new MapsAdapter(MapsActivity.this,
		...
		/*
		 * ArrayList<LocationModel> locations = di .getAllLocations(
		 * DISTANCE_BETWEEN_LOCATIONS ); for ( int i = 0; i < locations.size();
		 * i++ ) { LocationModel l = locations.get( i ); if ( l != null )
	...
	private void setLocationOnMap(LocationModel aLocation, String aTitle) {
		...
		LatLng loc = new LatLng(aLocation.getLatitude(),
