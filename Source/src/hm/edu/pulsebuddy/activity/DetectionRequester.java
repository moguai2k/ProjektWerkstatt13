    ...
    OnConnectionFailedListener
{
  ...
  {
    /* Request updates, using the default detection interval. The PendingIntent
     * sends updates to ActivityRecognitionIntentService */
   ...
   * necessary. This method facilitates multiple requests for a client, even if
   * a previous request wasn't finished. Since only one client object exists
   * while a connection is underway, no memory leaks occur.
   * 
