    ...
    OnConnectionFailedListener
{
  ...
  public void removeUpdates( PendingIntent requestIntent )
  {
    ...
    /* Set the request type, store the List, and request a activity recognition
     * client connection. */
  ...
  {
    /* If a client doesn't already exist, create a new one, otherwise return the
     * existing one. This allows multiple attempts to send a request without
     * causing memory leaks by constantly creating new clients. */
    if ( mActivityRecognitionClient == null )
    {
      // Create a new one
      setActivityRecognitionClient( new ActivityRecognitionClient( mContext,
          this, this ) );
    }
  ...
  public void onConnected( Bundle connectionData )
  {
    ...
    Log.d( ActivityUtils.ACTTAG, mContext.getString( R.string.connected ) );
  ...
  public void onDisconnected()
  {
    ...
    Log.d( ActivityUtils.ACTTAG, mContext.getString( R.string.disconnected ) );
  ...
  public void onConnectionFailed( ConnectionResult connectionResult )
  {
    ...
    if ( connectionResult.hasResolution() )
    {
       ...
       * dialog. This may direct the user to Google Play Store if Google Play
